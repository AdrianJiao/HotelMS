            ...
            <div class="span12">
                <div class="row-fluid">
                    <div class="span5">
                        ...
                        <div id="divOne">
                            <label id="commodityNameInfoclass=" yansered" style="margin-top:18px;">*</label>
                        </div>
                        <span "></span>
                    </div>
                    <script type="text/javascript">
                        $(function () {
                            ...
                            $("#commodityNameId").keyup(function () {

                                var commodity = {"commodityName": $(this).val()};

                                //alert(commodity.commodityName);

                                $.ajax({
                                    type: "POST",
                                    url: "${ctx}/commodity/checkAddCommodityName.do",
                                    ...
                                    success: function (data) {
                                        if (data.isExist) {
                                            $("#commodityNameInfo").css("color", "red");
                                            $("#commodityNameInfo").html("已存在，不能使用");
                                        } else {
                                            $("#commodityNameInfo").css("color", "green");
                                            $("#commodityNameInfo").html("可以使用");
                                        }
                    ...
                    <div class="span5 ">
                        ...
                        <select name="commodityTypeID" class="cboone inputone">
                            <c:forEach items="${commoditytypes}" var="item">
                                <option value="${item.commodityTypeID}"
                                        <c:if test="${item.commodityTypeName=='餐饮类'}">selected="selected"</c:if>>
                    ...
                    <div class="span5">
                        ...
                        <select name="uOMID" class="cboone inputone">
                            <c:forEach items="${list}" var="item" varStatus="vs">
                                <option value="${item}" <c:if test="${vs.index==0}">selected="selected"</c:if>>
                                        ${item}
                                </option>
                            </c:forEach>
                        </select>
