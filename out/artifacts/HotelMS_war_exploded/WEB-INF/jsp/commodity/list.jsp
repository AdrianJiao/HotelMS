...
<%--<%@ taglib prefix="page" uri="http://cskaoyan.cn/common/" %>--%>
                ...
                <select id="selectCboId" name="commodityTypeID" class="dgvone" style="width:80%;"
                    ...
                    <c:forEach items="${commoditytypes}" var="item">
                        <option value="${item.commodityTypeID}"
                                <c:if test="${item.commodityTypeID==commodityType}">selected="selected"</c:if>>
    ...
    <div class="dgvone">
        <table class="table table-condensed table-bordered table-striped" id="tableid">
            ...
            <c:forEach items="${page.rows}" var="item">
                <tr>
                    <td><input type="checkbox" name="id" value="${item.commodityName}"></td>
        ...
        <div class="span11">
            <div class="row-fluid">
                <div class="tcdPageCode" style="text-align:center;">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="span3">
                        ...
                        <div class="dgvone" style="margin-top:-18px;width:267px;height:443px;overflow:scroll;">
                            <table class="table table-condensed table-bordered table-striped" id="tableid"
                                ...
                                <c:forEach items="${commoditytypes}" var="item">
                                    <tr>
                                        <td><input type="checkbox" name="newid"
                                                   value="${item.commodityTypeID}"></td>
                                        <td>${item.commodityTypeName}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
